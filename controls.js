...
function mousePressed() {
    ...
    {
        circumcircleExplorerMousePressed();
    }
...
function mouseDragged() {
    if (projectMode.circumcircleExplorer) 
    {
        circumcircleExplorerMouseDragged();
    }
...
function mouseReleased() {
    if (projectMode.circumcircleExplorer) 
    {
        circumcircleExplorerMouseReleased();
    }
}

function circumcircleExplorerMousePressed() {
...
function circumcircleExplorerMouseDragged() {
    if (input_A.selected) {
...
function circumcircleExplorerMouseReleased() {
